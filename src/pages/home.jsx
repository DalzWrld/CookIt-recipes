  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 flex flex-col items-center text-center gap-6 h-full justify-center">
          <Badge variant="secondary" className="gap-1.5 bg-white/10 text-white border-white/20 backdrop-blur-sm">
            Your personal recipe book
          </Badge>
          <h1 className="font-heading text-4xl sm:text-5xl font-semibold tracking-tight text-white max-w-2xl leading-tight">
            Cook something <span className="text-green-400">delicious</span> today
          </h1>
